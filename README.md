...
<body>
  ...
  <header>
    ...
    <h1>Self-custody crypto wallets on devices move fast. Hackers love that..</h1>
  ...
  <section>
    <h2>Built by Humans Who Care</h2>
    <p>This project is created by:</p>
    <ul>
      <li><a href="https://www.linkedin.com/in/pieternatanael" target="_blank" rel="noopener">Pieter Natanael</a></li>
      <li><a href="https://www.linkedin.com/in/krishna-rp/" target="_blank" rel="noopener">Krishna Patidar</a></li>
    </ul>
  </section>
  ...
  <section>
    ...
    <form action="https://formspree.io/f/mdkddzvq" method="POST">
      ...
      <textarea name="feedback" placeholder="Your feedback" rows="4"></textarea>
      <button type="submit">Submit</button>
    </form>
    <p>Get early access. Stay informed. Be safe.</p>
    <div class="cta">
      <a href="https://apps.apple.com/in/app/slowlyy-crypto-wallet/id6751106285" target="_blank" class="appstore-button" rel="noopener">
        📲 Try Slowlyy on the Apple App Store
      </a>
